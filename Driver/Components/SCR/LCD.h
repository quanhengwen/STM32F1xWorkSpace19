...
//	#define LCD_BL_ON		api_pwm_oc_configuration((TIM_TypeDef*) TIM3_BASE,PWM_OUTChannel3,2000,10)	//(R61509V_BL_PORT->BSRR = R61509V_BL_PIN)
//	#define LCD_BL_OFF	api_pwm_oc_configuration((TIM_TypeDef*) TIM3_BASE,PWM_OUTChannel3,5,0)		//(R61509V_BL_PORT->BRR = R61509V_BL_PIN)
#else
