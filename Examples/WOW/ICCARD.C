...
//	api_pwm_oc_configuration(TIM4,PWM_OUTChannel1,20000,40);		//PWM设定
	...
	api_pwm_oc_configuration(TIM2,PWM_OUTChannel1,2,500);		//PWM设定
	api_usart_configuration_NR(USART2,19200,(u32*)RxdBuffer,BufferSize);	//USART_DMA配置--查询方式，不开中断
...
void ICCARD_Server(void)
{
	...
	if(systimecount>=2000)
	{
		...
		api_usart_send(USART2,(u32*)TxdBuffer,ICCARD_SendLenth);														//串口DMA发送程序
		API_GPIO_Toggle	(GPIOB,	GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9);		//将GPIO相应管脚输出翻转----V20170605
		API_GPIO_Toggle	(GPIOC,	GPIO_Pin_12);		//将GPIO相应管脚输出翻转----V20170605
		API_GPIO_Toggle	(GPIOD,	GPIO_Pin_2);		//将GPIO相应管脚输出翻转----V20170605
	}
	...
	if(Num)
	{
//	api_usart_send(USART2,(u32*)TxdBuffer,22);	//串口DMA发送程序
//	api_usart_send(USART2,(u32*)ICCARD_CMD_SetDataBlock,Num);	//串口DMA发送程序
//	api_usart_send(USART2,(u32*)ICCARD_CMD_SetReaderID,sizeof(ICCARD_CMD_SetReaderID));	//串口DMA发送程序
//	api_usart_send(USART2,(u32*)ICCARD_CMD_GetReaderID,sizeof(ICCARD_CMD_GetReaderID));	//串口DMA发送程序
